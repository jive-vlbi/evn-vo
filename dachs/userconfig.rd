	...
	<STREAM id="registry-interfacerecords">
		...
		<resRec id="authority">
			<meta>
				...
				title: \\metaString{authority.title}{EVN Data Archive}
				shortName: \\metaString{authority.shortName}
				subject: Authority
				managingOrg: \\metaString{publisher}
				referenceURL: \\metaString{authority.referenceURL}{http://www.evlbi.org}
				identifier: ivo://\getConfig{ivoa}{authority}
				sets: ivo_managed
			</meta>
			<meta name="description">
				\\metaString{authority.description}{JIVE manages the EVN Data Archive on behalf of the European VLBI Network}
			</meta>
		</resRec>
